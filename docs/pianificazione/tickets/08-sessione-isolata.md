...
- [x] Delegare versioni delle decisioni, perimetro, base e verifiche richieste a un worktree identificabile.
- [x] Modifiche locali preesistenti nel progetto sorgente restano byte-for-byte intatte; indice e branch originali restano preservati.
