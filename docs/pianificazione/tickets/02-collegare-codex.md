...
- [x] Versione del componente ufficiale rilevata e protocollo verificato; provider OpenAI esplicito per il processo di Trama.
- [x] account/read precede il login: un account disponibile viene riconosciuto senza ripetere OAuth o copiare token.
