...
- Il composer segue l'ADR 0010: selezione per bozza e dialogo, preferenze separate per provider e fotografia dei turni accodati. UX02 riusa questo comportamento senza introdurre una seconda selezione del modello.
