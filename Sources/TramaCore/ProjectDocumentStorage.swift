...
public struct ProjectDocumentStorage {
    ...
    public func load() throws -> ProjectDocument {
        ...
        if document.schemaVersion < ProjectDocument.currentSchemaVersion {
            ...
            // Schema 4 adds the optional Coordinator state, schema 5 its mandate and decision cards and
            // schema 6 the project team: nothing to convert. The bump keeps older builds from rewriting these documents.
